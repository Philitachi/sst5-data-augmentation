Backtranslation Augmentation for SST-5 Dataset

Description

This repository contains:

The source code used to perform backtranslation-based data augmentation on the SST-5 (Stanford Sentiment Treebank) dataset.
